...
if($("#google_ptm_map").length > 0){
    var gPTMCords = new google.maps.LatLng(-13.521974, -71.949020);
    ...
    var cords = new google.maps.LatLng(-13.521974, -71.749020);
    var marker = new google.maps.Marker({position: cords, map: gPTM, title: "Marker 1"});    
    cords = new google.maps.LatLng(-13.321974, -72);
    marker = new google.maps.Marker({position: cords, map: gPTM, title: "Marker 2"});
    cords = new google.maps.LatLng(-13.121974, -71.349020);
