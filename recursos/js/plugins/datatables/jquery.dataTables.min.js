...
sEmptyTable:"No data available in table",sInfo:"Mostrar _START_ a _END_ de _TOTAL_ registros",sInfoEmpty:"Mostrar 0 a 0 de 0 registros",sInfoFiltered:"(filtrado desde _MAX_ registros en total)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"<span class='hidden-sm hidden-xs'>Mostrar _MENU_ registros</span>",sLoadingRecords:"Cargando...",sProcessing:"Procesando...",sSearch:"<span class='hidden-sm hidden-xs'>Busqueda:</span>",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"No se encontraron registros."},oSearch:h.extend({},p.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",sPaginationType:"simple_numbers",
